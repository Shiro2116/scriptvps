...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "https://raw.githubusercontent.com/Shiro2116/scriptvps/master/screenfetch"
...
wget https://raw.githubusercontent.com/Shiro2116/scriptvps/master/vnstat_php_frontend-1.5.1.tar.gz
...
wget -O /etc/stunnel/stunnel.pem "https://raw.githubusercontent.com/Shiro2116/scriptvps/master/updates/stunnel.pem"
wget -O /etc/stunnel/stunnel.conf "https://raw.githubusercontent.com/Shiro2116/scriptvps/master/c7/stunnel.conf"
...
# install mrtg
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/Shiro2116/scriptvps/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/Shiro2116/scriptvps/master/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/gugun09/Shiro2116/scriptvps/mrtg.conf" >> /etc/mrtg.cfg
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/Shiro2116/scriptvps/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/Shiro2116/scriptvps/master/badvpn-udpgw64"
fi
...
# setting banner
rm /etc/issue.net
wget -O /etc/issue.net "https://raw.githubusercontent.com/Shiro2116/scriptvps/master/issue.net"
...
# download script
cd
wget https://raw.githubusercontent.com/Shiro2116/scriptvps/master/install-premiumscript.sh -O - -o /dev/null|sh
